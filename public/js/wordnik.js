...
function wordSearch() {
    ...
    var word = document.getElementById('dictionaryResultWord');
    var definition = document.getElementById('dictionaryResultDefinition');
    var example = document.getElementById('dictionaryResultExample');
    var spell = document.getElementById('dictionaryResultSpell');
    spell.innerHTML = '';
    word.innerHTML = '';
    ...
    request1.onload = function () {
        ...
        if (request1.status >= 200 && request1.status < 400) {
            ...
            word.innerHTML = data[0].word;      //  get a random definition
            definition.innerHTML = data[0].text;
            console.log(data);
        } else {
    ...
    request2.onload = function () {
        ...
        if (request2.status >= 200 && request2.status < 400) {
            ...
            example.innerHTML = "Word not found.";
        }
    }
    request2.send();
    ...
    request3.onload = function () {
        ...
        if (request3.status >= 200 && request3.status < 400) {
            ...
            spell.innerHTML = "Word not found.";
        }
    }
    request3.send();
}