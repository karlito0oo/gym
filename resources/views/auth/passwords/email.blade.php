		...
		<div class="card border-grey border-lighten-3 px-2 py-2 m-0">
			...
			<div class="card-body collapse in">	
				<div class="card-block">
                    ...
                    @endif
                    <form class="form-horizontal form-simple" method="POST" action="{{ route('password.email') }}" novalidate>
                        @csrf
						...
						<button type="submit" class="btn btn-primary btn-lg btn-block"><i class="icon-email"></i> 
