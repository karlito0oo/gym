  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
    <div id="app">
        ...
        <div class="main-menu-content">
            ...
            <li class="nav-item {{ collect(request()->segments())->last() == 'readings' ? 'active' : ''}}"><a href="{{ url('/home/readings') }}"><i class="icon-home"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Reading Comprehesion</span></a>
    ...
    <script src="{{ asset('js/app.js') }}"></script>
        ...
        <script>
        CKEDITOR.replace('storyTextarea');</script> -->
        <!-- END PAGE LEVEL JS-->
  </body>
</html>
